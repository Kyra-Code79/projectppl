    ...
    while ($data = mysqli_fetch_array($query)) {
        ...
        <center>
                ...
                <tr>
                    <td width='70%' align='CENTER' vertical-align='top'>
                        <span style='color:black;'>
                            <b>Kelompok 1</b></br>Medan</span>
                    </td>
                </tr>
                <tr>
                    <td colspan='4'>
                        <span style='text-align:left; font-size:12pt'>No Transaction : <?= $no_transaksi; ?></span>
                    </td>
                </tr>
                <tr>
                    <td colspan='4'>
                        <span style='text-align:left; font-size:12pt'>Date :
                            <?= date_format($tanggal, "d-m-Y"); ?></span>
                    </td>
                </tr>
                <tr>
                    <td colspan='4'>
                        <span style='text-align:left; font-size:12pt'>No Table : <?= $data['no_meja']; ?></span>
                    </td>
                </tr>
                <tr>
                    <td colspan='4'>
                        <span style='text-align:left; font-size:12pt'>Cashier : <?= $data['nama_pegawai']; ?></span>
                    </td>
                </tr>
            </table>
            ...
            <table cellspacing='0' cellpadding='0' style='width:500px; font-size:12pt; font-family:calibri;  border-collapse: collapse;' border='0'>
                ...
                <tr>
                    <td colspan='4'>
                        <div style='text-align:right; color:black'>Total Payment : </div>
                    </td>
                    <td style='text-align:right; font-size:16pt; color:black'>
                ...
                <tr>
                    <td colspan='4'>
                        <div style='text-align:right; color:black'>Change Money : </div>
                    </td>
                    <td style='text-align:right; font-size:16pt; color:black'>
